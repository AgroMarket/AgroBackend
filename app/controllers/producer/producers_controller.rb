class Producer::ProducersController < ApplicationController
  ...
  private
    ...
    def producer_params
      params.require(:producer).permit(:email, :password, :name, :phone, :address, :producer_logo, :producer_brand, :producer_description, :producer_address, :producer_phone, :inn)
    end
end
